/*#import "GeoLocationFinderPlugin.h"
#import <geo_location_finder/geo_location_finder-Swift.h>

@implementation GeoLocationFinderPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  [SwiftGeoLocationFinderPlugin registerWithRegistrar:registrar];
}
@end
*/
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"geo_location_finder"
            binaryMessenger:[registrar messenger]];
  GeoLocationFinderPlugin* instance = [[GeoLocationFinderPlugin alloc] init];
