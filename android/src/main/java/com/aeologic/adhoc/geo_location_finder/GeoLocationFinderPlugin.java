package com.aeologic.adhoc.geo_location_finder;
...
import com.aeologic.adhoc.geo_location_finder.util.LocationFusedAPIUtility;
...
/**
 * GeoLocationFinderPlugin
 */
public class GeoLocationFinderPlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener {
    private static final String TAG = GeoLocationFinderPlugin.class.getSimpleName();
    private static final int REQUEST_ENABLE_GPS_CODE = 101;
    private static final String METHOD_CHANNEL = "geo_location_finder";
    private Activity _activity;
    private Result _result;

    public GeoLocationFinderPlugin(Activity _activity) {
        this._activity = _activity;
    }

    public static void registerWith(PluginRegistry.Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), METHOD_CHANNEL);
        final GeoLocationFinderPlugin instance = new GeoLocationFinderPlugin(registrar.activity());
